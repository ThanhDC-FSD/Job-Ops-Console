...
export const api = {
  ...
  recallRun: (runId) => request(`/api/runs/${runId}/recall`, { method: 'POST' }),
  rescheduleRun: (runId, payload) => request(`/api/runs/${runId}/reschedule`, { method: 'POST', body: JSON.stringify(payload) }),
